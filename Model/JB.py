...
def jb_test(element_parameters):
    """
        对DataFrame中的每个列执行Jarque-Bera检验，并绘制直方图与正态分布拟合曲线。
    ...
    for idx, col in enumerate(element_parameters.columns):
        ...
        # Jarque-Bera检验
        jb_stat, p_val = jarque_bera(data)
        # 绘制直方图
    ...
    plt.tight_layout()
    plt.savefig('../Chart/jb_plots.png', bbox_inches='tight', dpi=300)  # 保存图像
    plt.show()
